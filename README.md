...
&nbsp;
![Profile Views](https://komarev.com/ghpvc/?username=yassineazouz&color=a855f7&style=for-the-badge&label=VIEWS)
...
<img src="https://skillicons.dev/icons?i=react,ts,js,html,css,sass&theme=dark&perline=6" />

**Backend**

<img src="https://skillicons.dev/icons?i=nodejs,express,java,spring,sequelize&theme=dark&perline=5" />

**Databases**

<img src="https://skillicons.dev/icons?i=postgres,mongodb,firebase&theme=dark&perline=3" />

**Tools & Workflow**

<img src="https://skillicons.dev/icons?i=docker,git,gitlab,linux,postman&theme=dark&perline=5" />
...
|:-:|---------|-------|------------|
| 🧠 | **[Inventory Manager](https://github.com/yassineazouz/Inventory-manager-app)** | `React` · `Node.js` · `PostgreSQL` · `Sequelize` | Real-time stock management · REST API · dashboard |
| 📋 | **[To-Do List App](https://github.com/yassineazouz/TodoList)** | `React` · `Spring Boot` · `MongoDB` | Full CRUD · authentication · responsive UI |
| 🌐 | **[Personal Portfolio](https://yassineazouz.dev)** | `React` · `TypeScript` · `CSS` | Showcase of projects & skills |
...
<table>
<tr>
<td width="110" align="center"><b>2024</b><br/><sub>💻</sub></td>
<td>

**Full Stack Developer Intern — ETS**
<br/>Built a full-stack web dashboard for real-time monitoring & remote control · developed the React front-end and the Node.js REST API + WebSocket data flow.

</td>
</tr>
<tr>
<td width="110" align="center"><b>2022</b><br/><sub>🌐</sub></td>
<td>

**Full Stack Developer Intern — Dawaya**
<br/>Developed features on a healthcare web platform (React + Node.js) · implemented real-time geolocation with the Google Maps API & Firebase Realtime DB.
